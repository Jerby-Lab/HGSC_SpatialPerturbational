...
#'
#' @param r1.smi Processed Discovery data (optional).
#' @param r.xenium Processed Validation 1 data (optional).
#' @param r1.xenium Processed Validation 1 data specific to T/NK cells(optional).
#' @param R Results from the "tumor infiltration program" analysis (optional).
#' @param r Processed Discovery dataset (default is the same as r.smi).
#' @param morph Morphology data for stroma. 
...
#' @return Matrix of colors corresponding to TIP scores.
#' @export
...
HGSC_Fig2d_T_states <- function(r1){
  return()
}
...
#' @param morph Morphology data of the stroma 
